...
class CollectingActor(ActorBase):
    ...
    period = Property.Number("PWM period (sec)", configurable=True, default_value=8)
    maxSpeed = Property.Number("Sampling rate at 100% PWM, ml / h", configurable=True, default_value=2000)
    power = 100
    enabled = False
