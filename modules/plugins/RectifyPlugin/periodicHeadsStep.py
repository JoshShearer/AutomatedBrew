...
class PeriodicHeadsStep(StepBase, BaseColletingStep):
    closedTime = Property.Number("Accumulation time, min", configurable=True, default_value=10)
    openTime = Property.Number("Reset time, sec", configurable=True, default_value=60)
